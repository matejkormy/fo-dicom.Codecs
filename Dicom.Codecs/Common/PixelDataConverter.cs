...
namespace Dicom.Codecs.Common
{
    ...
    /// </summary>
    internal static class PixelDataConverter
    {
        /// <summary>
        ...
        public static byte[] YbrFullToRgb(byte[] oldPixels)
        {
            var newPixels = new byte[oldPixels.Length];
        ...
        /// <returns>Array of pixel data in RGB photometric interpretation.</returns>
        public static byte[] YbrFull422ToRgb(byte[] oldPixels, int width)
        {
        ...
        /// <param name="width">Image width.</param>
        /// <returns>Array of pixel data in RGB photometric interpretation.</returns>
        public static byte[] YbrPartial422ToRgb(byte[] oldPixels, int width)
        {
            var newPixels = new byte[oldPixels.Length / 4 * 2 * 3];
        ...
        public static byte[] ReverseBits(byte[] oldPixels)
        {
